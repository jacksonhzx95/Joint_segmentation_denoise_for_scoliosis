...
from mmseg.models.common import generation_init_weights
from mmseg.models.builder import COMPONENTS
...
class Discriminator(nn.Module):
    ...
    def __init__(self,
        ...
        # We use norm layers in the patch discriminators.
    ...
    def forward(self, x):
        ...
        pred = self.fc(x)
        # pred = self.fc(x.view(x.size(0), -1))
        return pred
